...
\begin{figure}[H]
\begin{tabular}{cc}
	\captionbox*{Laptop-Arbeitsplatz}{\includegraphics[width=0.5\textwidth]{laptop.jpg}} &
	\captionbox*{Eigene Leiterplatten ätzen}{\includegraphics[width=0.5\textwidth]{aetzen.jpg}} \\
	\captionbox*{3D-gedrucktes Schloss Rapperswil}{\includegraphics[width=0.5\textwidth]{schloss.jpg}} &
	\captionbox*{Stand am Frühlingsfest 2016}{\includegraphics[width=0.5\textwidth]{fruehlingsfest.jpg}} \\
	\captionbox*{Ferienpass 2016: Löten}{\includegraphics[width=0.5\textwidth]{fepa.jpg}} &
	\captionbox*{Ferienpass 2016: 3D-Design}{\includegraphics[width=0.5\textwidth]{fepa2.jpg}} \\
\end{tabular}
\end{figure}
