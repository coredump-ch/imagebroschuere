...
\usepackage[english]{babel} % Use hyphenation
...
On this page you find a short summary of the whole document.

\subsection{About Us}

\begin{itemize}
	\item We are an association located in Rapperswil, which provies technology
		affine people infrastructure and an environment for non-commercial
		projects. Apart form that we pursue educational projects like the
		Ferienpass Rapperswil-Jona or public lectures.
	...
	\item Einige Projekte unserer Mitglieder: Farbige interaktive LED-Steuerungen
		...
		Obersee mit LoRaWAN, selber entwickelte Open Source PCB-Design-Software,
		orthopädische Alltagshilfen aus dem 3D-Drucker, eine selbst gebaute
...
Apps sowie auch über Programmier-Schnittstellen zugänglich machen. Die
Kommunikation wird über LoRaWAN realisiert.
...
\begin{tabular}{cc}
	...
	\captionbox*{Stand am Frühlingsfest 2016}{\includegraphics[width=0.5\textwidth]{img/fruehlingsfest.jpg}} \\
